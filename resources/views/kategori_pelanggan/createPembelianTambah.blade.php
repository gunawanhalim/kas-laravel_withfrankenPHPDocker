...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
          <h4 class="card-title">TAMBAH PEMBELIAN PELANGGAN</h4>
          <form method="POST" action="{{ route('pelangganPembelian.storetambah') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 mb-2">
                   ...
                   <input type="text" class="form-control" name="nama_sales" id="nama_sales" autocomplete="off" readonly>
                ...
                <input type="text" class="form-control" name="kategori" id="kategori" autocomplete="off" hidden> --}}
                 <div class="col-sm-6 mb-2">
                   ...
                   {{-- <input type="readonly" class="form-control" name="nama_akun" id="nama_akun" autocomplete="off" readonly> --}}
          ...
          <a href="/utang.php" class="btn btn-light">Cancel</a>
        </form>
      </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#nomor_bukti').select2({
        ...
        $container.text(data.text + ' - ' + data.nomor_nota + '-' + data.nama_sales);
        return $container;
    },
        templateSelection: function (data) {
            $('#nama_sales').val(data.nama_sales); // Isi otomatis input alamat
