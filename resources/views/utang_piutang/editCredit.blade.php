...
@section('title', 'Edit Utang ' . $credit->nomor_bukti)
    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Nomor Bukti: {{$credit->nomor_bukti}}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('credit.update', $credit->nomor_bukti) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama_akun">Nama Akun</label>
                        <input type="text" class="form-control" id="nama_akun" name="nama_akun" value="{{ $credit->nama_akun }}" required>
                    </div>
                    <div class="form-group">
                        <label for="nama_user">Nama User</label>
                        <input type="text" class="form-control" id="nama_user" name="nama_user" value="{{ $credit->nama_user }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            @if($credit->kategori == "1")
                            <option value="1">Pemasukan</option>
                            <option value="2">Pengeluaran</option>
                            @elseif ($credit->kategori =="2")
                            <option value="2">Pengeluaran</option>
                            <option value="1">Pemasukan</option>
                            @endif
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jumlah" name="jumlah" value="IDR {{ number_format($credit->jumlah, 0, ',', '.') }}" oninput="formatAngka(this)" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="dateTime-local" class="form-control" id="tanggal_bukti" name="tanggal_bukti" value="{{ $credit->tanggal_bukti }}" required>
                    </div>
...
<script src="{{ asset('node_modules/select2/dist/js/select2.min.js') }}"></script>
    <script>
        ...
        input.value = 'IDR ' + nilai;
            ...
            var defaultNota = {
                id: "{{ $credit->nomor_nota }}",
                text: "{{ $credit->nomor_nota }}"
            };
    ...
    var defaultNamaPelanggan = {
                id: "{{ $credit->nama_pelanggan }}",
                text: "{{ $credit->nama_pelanggan }}"
            };
