...
@section('content')
    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/debit.php">Kembali</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">KAS DEBIT </h4>
            <a href="{{route('debit.add',['nama_akun'=> $nama_akun])}}" class="btn btn-primary mb-4"> Tambah data </a>
            <div class="my-2">
                <form method="GET" action="{{ route('debit.show', ['nama_akun' => $nama_akun]) }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('piutang.edit', ['nomor_bukti'=> $item->nomor_bukti]) }}" class="btn btn-md btn-secondary"> Edit</a>
  ...
  <script>
    $(document).ready(function() {
        ...
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            var action = "{{ route('debit.destroy', ':nomor') }}";
