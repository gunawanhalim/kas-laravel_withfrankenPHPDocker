...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('pembayaran.storetambah') }}">
            @csrf
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-2">
                   ...
                   <input type="text" class="form-control" name="nomor_bukti" id="nomor_bukti" value="{{$pembayaran->nomor_bukti}}" readonly autocomplete="off">
                 </div>
                @php
                ...
                <div class="col-sm-6 mb-2">
                   ...
                   <input type="text" class="form-control" name="nomor_nota" value="{{$pembayaran->nomor_nota}}" id="nomor_nota" autocomplete="off" readonly>
                ...
                <div class="col-sm-6 mb-2">
                   ...
                   {{-- <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="{{$pembayaran->nama_pelanggan}}" autocomplete="off" readonly> --}}
                   <select id="nama_pelanggan" name="nama_pelanggan" class="form-control">
                    @foreach ($pelanggan as $item)
                        <option value="{{ $item->nama_pelanggan }}" {{ $item->nama_pelanggan == $pembayaran->nama_pelanggan ? 'selected' : '' }}>
                            {{ $item->nama_pelanggan }}
                        </option>
                    @endforeach
                    </select>
                ...
                <input type="text" class="form-control" name="kategori" id="kategori" autocomplete="off" hidden> --}}
                 <div class="col-sm-6 mb-2">
                   ...
                   {{-- <input type="text" class="form-control" name="nama_akun" id="nama_akun" value="{{$pembayaran->nama_akun}}" autocomplete="off" readonly> --}}
                    ...
                    @foreach ($kas as $item)
                    <option value="{{ $item->nama_akun }}" {{ $item->nama_akun == $pembayaran->nama_akun ? 'selected' : '' }}>
                        {{ $item->nama_akun }}
                    </option>
                    @endforeach
                </select>
