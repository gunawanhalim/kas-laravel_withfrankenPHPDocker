...
@section('title', 'Kategori Hutang '.$decodedCategory)
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">KATEGORI HUTANG {{$decodedCategory}} </h4>
            <div class="my-2">
                <form method="GET" action="{{ route('link-kategori', ['category' => $decodedCategory]) }}">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @if ($hutang->count() > 0)
                        ...
                        @foreach ($hutang as $item)
                            ...
                            @if ($item->total_jumlah != 0) <!-- Hanya tampilkan baris jika saldo tidak sama dengan 0 -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuIconButton1">
                                                ...
                                                <a href="/pinjaman-kategoriDetail/{{$item->nomor_bukti}}" type="button" class="dropdown-item">
                                                    Detail Kategori
                                                </a>                                  
                                            </div>
                                        </div>
