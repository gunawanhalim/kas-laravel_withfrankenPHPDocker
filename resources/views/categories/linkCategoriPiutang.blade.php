...
@section('title', 'Kategori Piutang '.$decodedCategory)
...
<style>
    ...
    @media (min-width: 1340px) {
        .table-container {
            transform: scale(0.80); /* Mengurangi skala tabel menjadi 60% dari ukuran aslinya */
        }
    }
...
<div class="page-header">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/piutang.php">Piutang</a></li>
            <li class="breadcrumb-item active" aria-current="page">Detail Kategori {{$decodedCategory}}</li>
        </ol>
    </nav>
</div>
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">KATEGORI PIUTANG {{$decodedCategory}} </h4>
            <div class="my-2">
                <form method="GET" action="/link-kategori-piutang/{{$decodedCategory}}">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuIconButton1">
                                      ...
                                      <a href="/pembayaran-kategoriDetail/{{$item->nomor_bukti}}" type="button" class="dropdown-item">
                                        Detail
                                    </a>                                      
