    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pelanggan Penjualan</li>
            </ol>
        </nav>
    </div>
                ...
                <tbody>
                  @foreach ($pelanggan as $qp)
                    <tr>
                      ...
                      <td><a href="detail-penjualan-pelanggan/{{$qp->nama_pelanggan}}" style="color:black;">
                        {{$qp->nama_pelanggan}}</a> 
                    </td>
                      <td> {{$qp->alamat}} </td>
                      <td> 
                        ...
                        <form action="{{ route('deletePelanggan.destroy', $qp->id) }}" method="POST">
                          @csrf
                          @method('DELETE')
