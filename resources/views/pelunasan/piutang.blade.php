...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">PELUNASAN KATEGORI PIUTANG</h4>
            <div class="my-2">
                <form method="GET" action="/pelunasan-piutang">
            ...
            <div class="table-container">
                <table class="table table-bordered table-sm">
                    ...
                    @if ($pelunasan->count() > 0)                        
                        ...
                        $saldo =0;
                        @endphp
                        @foreach ($pelunasan as $index => $item)
                        @php
                        $jumlah = $item->jumlah;
                        if ($i == 0) {
                            $saldo = $jumlah;
                        ...
                        <tr class="{{ $item->jumlah <0 ? 'table-danger' : 'table-success' }}">
                            ...
                            <td>
                                <a href="/pembayaran-kategoriDetail/{{$item->nomor_bukti}}" type="button" style="width: 50px;" class="btn btn-sm btn-outline-dark btn-fw">
