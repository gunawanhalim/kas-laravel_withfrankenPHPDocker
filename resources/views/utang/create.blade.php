...
<div class="page-header"> ->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Piutang</li>
        </ol>
    </nav>
</div>
          ...
          <form method="POST" action="{{ route('piutang.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 mb-2">
                   ...
                   <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" autocomplete="off" readonly>
                ...
                <input type="text" class="form-control" name="kategori" id="kategori" autocomplete="off" hidden>
                 <div class="col-sm-6 mb-2">
                   ...
                   <input type="text" class="form-control" name="jumlah" id="jumlah" autocomplete="off" oninput="formatAngka(this)" readonly>
                   </div>
                   <div class="col-sm-6 mb-2">
