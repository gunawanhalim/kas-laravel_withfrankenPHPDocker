...
@section('title', 'Edit Utang ' . $piutang->nomor_bukti)
    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Nomor Bukti: {{$piutang->nomor_bukti}}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('piutang.update', $piutang->nomor_bukti) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama_akun">Nama Akun</label>
                        <input type="text" class="form-control" id="nama_akun" name="nama_akun" value="{{ $piutang->nama_akun }}" required>
                    </div>
                    <div class="form-group">
                        <label for="nama_user">Nama User</label>
                        <input type="text" class="form-control" id="nama_user" name="nama_user" value="{{ $piutang->nama_user }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            @if($piutang->kategori == "1")
                            <option value="1">Pemasukan</option>
                            <option value="2">Pengeluaran</option>
                            @elseif ($piutang->kategori =="2")
                            <option value="2">Pengeluaran</option>
                            <option value="1">Pemasukan</option>
                            @endif
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jumlah" name="jumlah" value="IDR {{ number_format($piutang->jumlah, 0, ',', '.') }}" oninput="formatAngka(this)" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="dateTime-local" class="form-control" id="tanggal_bukti" name="tanggal_bukti" value="{{ $piutang->tanggal_bukti }}" required>
                    </div>
...
<script src="{{ asset('node_modules/select2/dist/js/select2.min.js') }}"></script>
    <script>
        ...
        input.value = 'IDR ' + nilai;
            ...
            var defaultNota = {
                id: "{{ $piutang->nomor_nota }}",
                text: "{{ $piutang->nomor_nota }}"
            };
    ...
    var defaultNamaPelanggan = {
                id: "{{ $piutang->nama_pelanggan }}",
                text: "{{ $piutang->nama_pelanggan }}"
            };
