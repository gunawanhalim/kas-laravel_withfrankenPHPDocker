...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">KAS UTANG </h4>
            <div style="overflow: hidden;">
                <a href="{{route('pembelian.add')}}" class="btn btn-primary mb-4" style="float: left;">Tambah Pembelian</a>
                <a href="{{route('pelunasan.utang')}}" class="btn btn-info mb-4" style="float: right;">Lihat Pelunasan</a>
            </div>      
            <div class="my-2">
                <div class="my-2">
                <form method="GET" action="{{ route('utang.index') }}">
                    ...
                    <select class="form-control form-control-sm mb-3" style="width: 200px; height:30px;" aria-label=".form-select-sm example" name="category">
                        ...
                        <option value="nomor_nota" @if(request('utang') == 'nomor_nota') selected @endif>Nomor Nota</option>
                        {{-- <option value="nama_pelanggan" @if(request('utang') == 'nama_pelanggan') selected @endif>Nama Pelanggan</option> --}}
                        <option value="nama_akun" @if(request('utang') == 'nama_akun') selected @endif>Nama Akun</option>
                        <option value="nomor_bukti" @if(request('utang') == 'nomor_bukti') selected @endif>Nomor Bukti</option>
                        <option value="nama_user" @if(request('utang') == 'nama_user') selected @endif>Nama User</option>
                        <option value="nama_user" @if(request('utang') == 'nama_user') selected @endif>Nama Sales</option>
                    </select>
                    <div class="mb-2 my-2">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/detail-perutangan/{{$item->nomor_bukti}}">{{$item->nomor_bukti}}</a> </td>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    {{-- <a href="{{ route('utang.edit', ['nomorBukti'=> $item->nomor_bukti]) }}" class="dropdown-item"> Edit</a> --}}
                                    <button type="button" class="dropdown-item" data-toggle="modal" data-target="#deleteModal" data-nomor-bukti="{{ $item->nomor_bukti }}">
                                        Hapus
                                    </button>
                                    @endif
                                    <a href="/pinjaman-add/{{$item->nomor_bukti}}" type="button" class="dropdown-item">
                                        Pinjaman
                                    </a>                                  
