                ...
                <form class="forms-sample" action="{{route('pembelian.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        {{-- <div class="col-sm-6 mb-2">
                           ...
                           <input type="text" class="form-control" id="alamat" name="alamat" placeholder="" title="Otomatis terinput ketika mengisi nama pelanggan" autocomplete="off" readonly>
                         </div> --}}
                         <div class="col-sm-6 mb-2">
                  ...
                  <a href="/pembelian" class="btn btn-light">Cancel</a>
                </form>
              </div>
            </div>
        </div>
...
$('#cariKategori').select2({
    ...
    const tanggalNota = document.getElementById('tanggal_nota');

    tanggalNota.addEventListener('change', function() {
        // Remove focus immediately after value is selected
        tanggalNota.blur();
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateNomorNota() {
        if (generateCheckbox.checked) {
            fetch('/addPembelian/generate-nomor-nota')
                .then(response => {
                    if (!response.ok) {
