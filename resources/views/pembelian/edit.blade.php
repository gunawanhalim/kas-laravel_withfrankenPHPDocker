...
<div class="page-header">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/pembelian">Penjualan</a></li>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pembelian.update', $sale->nomor_nota) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        {{-- <div class="col-sm-5 mb-5 mr-5">
                            ...
                            <input id="alamat" name="alamat" type="text" class="form-control" value="{{ $sale->alamat }}">
                        </div> --}}
                        <div class="col-sm-5 mb-5 mr-5">
                    ...
                    <a class="btn btn-md btn-secondary" href="/pembelian">Cancel</a>
                </form>
